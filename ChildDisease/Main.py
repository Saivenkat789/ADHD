...
main = Tk()
main.title("Pose Estimation–Enabled Behavioral Monitoring System for ADHD Diagnosis in Children ")
...
font = ('times', 15, 'bold')
title = Label(main, text='Pose Estimation–Enabled Behavioral Monitoring System for ADHD Diagnosis in Children')
